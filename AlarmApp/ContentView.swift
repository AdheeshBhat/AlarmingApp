...
struct ContentView: View {
    ...
    Database(users: [1: [createDate(year: 2025, month: 8, day: 29, hour: 11, minute: 1, second: 1):
                         ...
                         createDate(year: 2025, month: 9, day: 14, hour: 10, minute: 1, second: 1):
                            ReminderData(ID: 1, date: createDate(year: 2025, month: 9, day: 14, hour: 10, minute: 1, second: 1), title: "Make Doctor's Appointment",description: "3/31/2025", repeatSettings: RepeatSettings(repeat_type: "Daily", repeat_until_date: "Specific Date"), priority: "Low", isComplete: false, author: "user", isLocked: false),
                         createDate(year: 2025, month: 9, day: 14, hour: 9, minute: 1, second: 1):
                            ReminderData(ID: 1, date: createDate(year: 2025, month: 9, day: 14, hour: 9, minute: 1, second: 1), title: "Take Out Trash", description: "4/2/2025", repeatSettings: RepeatSettings(repeat_type: "Daily", repeat_until_date: "2025-07-30"), priority: "High", isComplete: false, author: "user", isLocked: false),
                         createDate(year: 2025, month: 9, day: 15, hour: 6, minute: 1, second: 1):
                            ReminderData(ID: 1, date: createDate(year: 2025, month: 9, day: 15, hour: 6, minute: 1, second: 1), title: "Pick up Groceries", description: "4/15/2025", repeatSettings: RepeatSettings(repeat_type: "None", repeat_until_date: "Specific Date"), priority: "Low", isComplete: false, author: "user", isLocked: false),
                         createDate(year: 2025, month: 9, day: 15, hour: 7, minute: 1, second: 1):
                            ReminderData(ID: 1, date: createDate(year: 2025, month: 9, day:15, hour: 7, minute: 1, second: 1), title: "Water the Plants", description: "4/16/2025", repeatSettings: RepeatSettings(repeat_type: "None", repeat_until_date: "Specific Date"), priority: "Low", isComplete: false, author: "user", isLocked: false),
                         createDate(year: 2025, month: 9, day: 22, hour: 8, minute: 1, second: 1):
                            ReminderData(ID: 1, date: createDate(year: 2025, month: 9, day: 22, hour: 8, minute: 1, second: 1), title: "Example Title 1", description: "5/11/2025", repeatSettings: RepeatSettings(repeat_type: "None", repeat_until_date: "Specific Date"), priority: "Low", isComplete: false, author: "user", isLocked: false),
                         createDate(year: 2025, month: 10, day: 22, hour: 1, minute: 1, second: 1):
                            ReminderData(ID: 1, date: createDate(year: 2025, month: 10, day: 22, hour: 1, minute: 1, second: 1), title: "Example Title 2", description: "5/19/2025", repeatSettings: RepeatSettings(repeat_type: "None", repeat_until_date: "Specific Date"), priority: "Low", isComplete: false, author: "user", isLocked: false)],
                     2: [Date.now:
